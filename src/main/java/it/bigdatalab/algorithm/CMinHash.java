...
public abstract class CMinHash {
    ...
    protected CompressedGraph cGraph;
    protected int[] mMinHashNodeIDs;

    public CMinHash() {
    }

    public CMinHash(final CompressedGraph g, int numSeeds, double threshold, int[] nodes) {
    ...
    public CMinHash(final CompressedGraph g, int numSeeds, double threshold, IntArrayList seeds) {
    ...
    public CMinHash(final CompressedGraph g, int numSeeds, double threshold) {
        this.mNumSeeds = numSeeds;
        this.mThreshold = threshold;
        this.cGraph = g;
        this.mMinHashNodeIDs = new int[mNumSeeds];
